...
class lang_base(ABC):
    ...
    text_about_version: str = "Beta 0.3"
...
class zh_CN(lang_base):
    ...
    text_filetype_gba: str = "GBA ROM文件"
    text_filetype_gbc: str = "GBC ROM文件"
    text_filetype_gb: str = "GB ROM文件"
    text_filetype_nes: str = "NES ROM文件"
    ...
    text_use_rts: str = "使用即时存档"
    text_batteryless_autosave: str = "无电池存档自动存档"
...
class en_US(lang_base):
    ...
    text_filetype_png: str = "PNG file"
    text_filetype_gba: str = "GBA ROM file"
    text_filetype_gbc: str = "GBC ROM file"
    text_filetype_gb: str = "GB ROM file"
    text_filetype_nes: str = "NES ROM file"
    ...
    text_use_rts: str = "Use RTS"
    text_batteryless_autosave: str = "Batteryless save auto save"
